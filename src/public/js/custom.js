$(document).ready(function () {
    ...
    if (window.location.href.indexOf("/ethra/submit-form") > -1) {
        if (window.history.replaceState) {
            window.history.replaceState(null, null, '/ethra/user');
        }
    }
    ...
    if (((location.pathname.split("/")[2]) !== "") || ((location.pathname.split("/")[2]) == undefined)) {
        $('nav a[href^="/ethra/' + location.pathname.split("/")[2] + '"]').addClass('active');
    } else {
