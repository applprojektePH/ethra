                ...
                if (!err) {
                    for (let i = 0; i < rows.length; i++) {
                        ...
                        let order = {
                            ...
                            'anonymizedtext': (rows[i].anonymizedtext === "undefined" ? " " : rows[i].anonymizedtext),
                            'confidentiality': (rows[i].confidentiality === "undefined" ? " " : rows[i].confidentiality),
                            'confidentialitytext': (rows[i].confidentialitytext === "undefined" ? " " : rows[i].confidentialitytext),
                            'destroy': (rows[i].destroy === "undefined" ? " " : rows[i].destroy),
                            'deleted': (rows[i].deleted === "undefined" ? " " : rows[i].deleted),
                            'deletedtext': (rows[i].deletedtext === "undefined" ? " " : rows[i].deletedtext),
